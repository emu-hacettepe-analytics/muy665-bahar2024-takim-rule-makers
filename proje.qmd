...
proje_detay_data <- left_join(nüfus_data, evsel_atık_data, by = "İlçe", suffix = c(".nüfus", ".atık"))
proje_detay_data <- arrange(proje_detay_data, yıl)
